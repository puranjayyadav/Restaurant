"""
Google Maps Scraper - Food Type Grid Search
A standalone scraper for extracting food-specific place data from Google Maps.
Focused on different food types (desserts, cuisines, snacks, etc.)
...
FOOD_TYPE_LIST = {
    # === QUICK BITES & SNACKS ===
    "ice_cream_parlor": "ice cream parlor frozen yogurt gelato dessert",
    "donut_shop": "donut shop bakery sweets breakfast",
    "bagel_shop": "bagel shop deli breakfast sandwiches",
    "pretzel_cart": "pretzel stand soft pretzel street food",
    "popcorn_shop": "gourmet popcorn shop sweets snacks",
    "candy_store": "candy store chocolate sweets boutique",
    "cookie_shop": "cookie bakery fresh baked sweets",
    
    # === DESSERTS & SWEETS ===
    "cupcake_shop": "cupcake bakery sweets dessert shop",
    "pie_shop": "pie shop bakery desserts fruit pies",
    "cake_shop": "cake shop bakery wedding cakes desserts",
    "chocolate_shop": "chocolate shop artisanal truffles sweets",
    "macaron_shop": "macaron shop french bakery sweets",
    "baklava_shop": "baklava shop middle eastern sweets pastries",
    "gelato_shop": "gelato shop italian ice cream artisanal",
    
    # === INTERNATIONAL CUISINES ===
    "sushi_restaurant": "sushi restaurant japanese raw fish",
    "ramen_shop": "ramen shop japanese noodle soup",
    "taco_truck": "taco truck mexican street food authentic",
    "burrito_place": "burrito shop mexican fast casual",
    "pizza_place": "pizza restaurant wood fired artisan cheese",
    "pasta_house": "italian restaurant pasta fresh made authentic",
    "french_bistro": "french bistro wine bar classic cuisine",
    "spanish_tapas": "spanish tapas bar small plates wine",
    
    # === ASIAN CUISINES ===
    "dim_sum_house": "dim sum restaurant cantonese dumplings",
    "bibimbap_spot": "bibimbap korean rice bowl traditional",
    "pho_restaurant": "pho restaurant vietnamese noodle soup",
    "bubble_tea_shop": "bubble tea shop taiwanese boba drinks",
    "kbbq_restaurant": "korean bbq grill bulgogi traditional",
    "thai_restaurant": "thai restaurant pad thai curry authentic",
    "indian_curry": "indian restaurant curry tikka masala",
    "chinese_dumplings": "chinese dumpling house dim sum xiao long bao",
    
    # === AMERICAN CLASSICS ===
    "burger_joint": "burger restaurant craft burgers artisanal",
    "barbecue_spot": "barbecue restaurant smoked meats ribs",
    "steakhouse": "steakhouse prime rib aged beef",
    "hot_dog_stand": "hot dog stand nyc style street food",
    "fried_chicken": "fried chicken restaurant southern comfort food",
    "meatloaf_diner": "classic diner meatloaf mashed potatoes",
    
    # === HEALTHY & SPECIALTY ===
    "juice_bar": "juice bar cold pressed organic smoothies",
    "salad_bar": "salad restaurant healthy fresh organic",
    "smoothie_shop": "smoothie shop acai bowls healthy drinks",
    "poke_bowl": "poke bowl hawaiian fresh fish healthy",
    "grain_bowl": "grain bowl restaurant healthy quinoa bowls",
    "vegan_cafe": "vegan restaurant plant based healthy",
    
    # === BREAKFAST & BRUNCH ===
    "pancake_house": "pancake house breakfast buttermilk stacks",
    "waffle_shop": "waffle shop belgian breakfast sweets",
    "eggs_benedict": "eggs benedict brunch spot hollandaise sauce",
    "french_toast": "french toast restaurant brioche breakfast",
    "oatmeal_bar": "oatmeal bar steel cut overnight healthy",
    
    # === STREET FOOD & MOBILE ===
    "food_truck": "food truck gourmet street food mobile",
    "taco_stand": "taco stand mexican street food authentic",
    "hot_dog_cart": "hot dog cart nyc style street food",
    "crepe_cart": "crepe stand french street food sweet savory",
    "gyro_stand": "gyro stand greek street food authentic",
    
    # === ETHNIC SPECIALTIES ===
    "falafel_shop": "falafel shop middle eastern vegetarian street food",
    "shawarma_house": "shawarma restaurant middle eastern grilled meat",
    "empanada_shop": "empanada shop latin american pastry filled",
    "arepa_house": "arepa restaurant colombian venezuelan corn cakes",
    "jerk_chicken": "jerk chicken restaurant jamaican caribbean",
    "curry_house": "curry restaurant indian spice traditional",
    "ethiopian_restaurant": "ethiopian restaurant injera traditional",
    "lebanese_restaurant": "lebanese restaurant hummus shawarma",
    
    # === COFFEE & TEA ===
    "coffee_roaster": "coffee roaster specialty beans brewing",
    "tea_house": "tea house loose leaf artisanal blends",
    "matcha_cafe": "matcha cafe japanese green tea desserts",
    "espresso_bar": "espresso bar italian coffee traditional",
}
...
if __name__ == "__main__":
    ...
    print("--- Starting Food Type Scraper (All Neighborhoods) ---")
    ...
    for area_group, neighborhoods in NYC_AREAS.items():
        ...
        for hood in neighborhoods:
            ...
            # Inner Loop: Food Types
            for food_type_name, search_query in FOOD_TYPE_LIST.items():
                print(f"   > Searching for '{food_type_name}'...")
                ...
                try:
                    ...
                    if SUPABASE_ENABLED and results:
                        ...
                        save_batch_to_supabase(results, food_type_name, neighborhood_name)
                except Exception as e:
                    print(f"   [!] Error searching {food_type_name} in {hood}: {e}")
                    # Continue to next food type even if this one fails
                    continue 
