...
class LovedPlacesMapScreen extends StatefulWidget {
  ...
  const LovedPlacesMapScreen({super.key, required this.places});
...
class _LovedPlacesMapScreenState extends State<LovedPlacesMapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Default center (first place with valid coordinates)
    LatLng defaultCenter;
    if (validPlaces.isNotEmpty) {
      final firstPlace = validPlaces[0];
      defaultCenter = LatLng(_getLat(firstPlace)!, _getLng(firstPlace)!);
    } else {
