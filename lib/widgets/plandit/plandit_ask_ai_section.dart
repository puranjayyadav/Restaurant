...
import 'plandit_storyboard_view.dart';
...
class _PlanditAskAISectionState extends State<PlanditAskAISection> {
  ...
  List<CuratedSuggestion> get _filteredSuggestions {
    ...
    return curatedSuggestions.where((s) =>
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      if (_selectedLocation != null || _selectedVibe != null || _selectedSocialContext != null || _selectedTimeOfDay != null || _selectedCuisines.isNotEmpty) {
        activeFilters = {
          'vibe': _selectedVibe,
        ...
        if (_selectedLocation != null) {
          try {
            final results = await apiService.geocodeNominatim(_selectedLocation!);
            if (results.isNotEmpty) {
              final firstResult = results.first;
              activeFilters['latitude'] = firstResult['geometry']['location']['lat'];
              activeFilters['longitude'] = firstResult['geometry']['location']['lng'];
            }
          } catch (e) {
      ...
      // Navigate to StoryboardView with real data
      if (mounted) {
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _isFocused ? PlanditColors.border : PlanditColors.border.withOpacity(0.3),
              ),
              boxShadow: [
                BoxShadow(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                          ...
                          onTap: () async {
                            ...
                            if (result != null) {
                              setState(() {
                                ...
                                _selectedSocialContext = result['socialContext'];
                            ...
                            children: [
                              Container(
                                ...
                                child: Icon(
                                  Icons.tune_outlined,
                                  size: 16,
                                  color: (_selectedLocation != null || _selectedVibe != null || _selectedSocialContext != null || _selectedTimeOfDay != null || _selectedCuisines.isNotEmpty)
                                      ? PlanditColors.accent
                        ...
                        GestureDetector(
                          onTap: _controller.text.trim().isNotEmpty ? _handleSubmit : null,
                          child: Container(
                            width: 36,
                            height: 36,
                            decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            children: [
                              const Icon(Icons.auto_awesome, size: 10, color: PlanditColors.accent),
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                onTap: () => _handleSuggestionClick(suggestion.text),
                              );
                            },
                          ),
                        ),
